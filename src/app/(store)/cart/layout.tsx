		...
		return (
			<div className="flex min-h-[calc(100dvh-7rem)] items-center justify-center">
				<div className="text-center">
					...
					<p className="text-muted-foreground mt-2">Add some items to your cart to continue shopping.</p>
				</div>
			</div>
		);
	}
		...
		<div className="min-h-[calc(100dvh-7rem)] xl:grid xl:grid-cols-12 xl:gap-x-8">
			<div className="my-8 xl:col-span-7">
				<div className="sticky top-1">
					<h1 className="mb-4 text-3xl leading-none font-bold tracking-tight">{t("title")}</h1>
