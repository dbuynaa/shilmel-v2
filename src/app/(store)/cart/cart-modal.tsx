		...
		<CartAsideContainer>
			<div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
				<div className="flex items-center justify-between">
					<h2 className="text-accent-foreground/80 text-lg font-semibold">{t("title")}</h2>
					<YnsLink replace href="/cart" className="text-muted-foreground text-sm underline">
						{t("openFullView")}
					</YnsLink>
				</div>
			...
			<div className="border-accent border-t px-4 py-6 sm:px-6">
				...
				<p className="text-muted-foreground mt-0.5 text-sm">{t("shippingAndTaxesInfo")}</p>
