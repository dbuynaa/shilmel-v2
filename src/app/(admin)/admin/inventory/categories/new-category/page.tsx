...
import { AddCategoryForm } from "@/components/admin/forms/inventory/categories/add-category-form";
			...
			<div className="p-5">
				<Card className="max-w-5xl rounded-md bg-tertiary">
					<CardHeader className="px-5 pt-5">
						...
						<CardDescription className="text-base">Define new category of items</CardDescription>
					</CardHeader>
