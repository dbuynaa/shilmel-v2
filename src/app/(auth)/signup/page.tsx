...
import { SignUpWithPasswordForm } from "@/components/admin/forms/auth/signup-with-password-form";
				...
				<CardContent className="max-sm:w-full max-sm:max-w-[340px] max-sm:px-10">
					...
					<div className="relative">
						...
						<div className="relative mb-3 mt-6 flex justify-center text-xs uppercase">
							<span className="bg-background px-2">Or continue with magic link</span>
						</div>
					</div>
					<SignInWithEmailForm />
					<div className="relative">
						...
						<div className="relative mb-3 mt-6 flex justify-center text-xs uppercase">
							<span className="bg-background px-2">Or continue with password</span>
						</div>
					</div>
