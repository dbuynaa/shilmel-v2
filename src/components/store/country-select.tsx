...
} from "@/components/store/input-errors"
  ...
  return (
    ...
    >
      <CommandInput
        ...
        className="focus:outline-hidden focus:ring-3 my-2 h-8 border border-neutral-200 py-0 focus:border-neutral-300 focus:ring-neutral-100"
      />
      <CommandList>
