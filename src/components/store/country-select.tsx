...
import { ElWithErrors, type ElWithErrorsProps } from "@/components/store/input-errors";
	...
	return (
		...
		>
			<CommandInput
				...
				className="my-2 h-8 border border-neutral-200 py-0 focus:border-neutral-300 focus:ring-3 focus:ring-neutral-100 focus:outline-hidden"
			/>
			<CommandList>
