...
import { type SignInWithPasswordFormInput, signInWithPasswordSchema } from "@/lib/validations/auth";
...
export function SignInWithPasswordForm(): JSX.Element {
	...
	return (
		<Form {...form}>
			<form className="grid w-full gap-4" onSubmit={(...args) => void form.handleSubmit(onSubmit)(...args)}>
				<FormField
